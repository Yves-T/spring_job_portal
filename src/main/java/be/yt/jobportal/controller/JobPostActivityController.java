...
import be.yt.jobportal.entity.*;
import be.yt.jobportal.service.JobPostActivityService;
import be.yt.jobportal.service.JobSeekerApplyService;
import be.yt.jobportal.service.JobSeekerSaveService;
...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model, @RequestParam(value = "job", required = false) String job,
        ...
        addSearchParamsToModel(model, job, location, partTime, fullTime, freelance, remoteOnly, officeOnly,
                partialRemote, today, days7, days30);

        List<JobPostActivity> jobPost = getJobPostActivities(job, location, partTime, fullTime, freelance, remoteOnly,
    ...
    private List<JobPostActivity> getJobPostActivities(String job, String location, String partTime, String fullTime,
                                                       String freelance, String remoteOnly, String officeOnly,
                                                       String partialRemote, boolean today, boolean days7,
                                                       boolean days30) {
    ...
    private void addSearchParamsToModel(Model model, @RequestParam(value = "job", required = false) String job,
                                        @RequestParam(value = "location", required = false) String location,
                                        @RequestParam(value = "partTime", required = false) String partTime,
                                        @RequestParam(value = "fullTime", required = false) String fullTime,
                                        @RequestParam(value = "freeLance", required = false) String freelance,
